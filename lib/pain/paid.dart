...
class _PaidState extends State<Paid> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Оплачено', style: TextStyle(color: Color(0xFF1E8C0C),fontSize: 17.sp,fontWeight: FontWeight.w600)),
      ),
      body: Center(
        child: ListView(
              ...
              children:[
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: Color(0xFF1E8C0C)
                  ),
                  child: Center(child: Text('50 000 руб',style: AppTextStyles.tablePay,)),
                ),],
            ),
